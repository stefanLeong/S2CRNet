...
class Fusion(nn.Module):
    ...
    def forward(self, ori_img, x, f_feature, b_feature, label, withLabel):
        ...
        # import pdb;
        # pdb.set_trace()
        return fusion_img, param1, param2, param3

class CreateNetFusion_re(nn.Module):
    def __init__(self, model, plane=64, fusion=Fusion, final_relu=False, stack=False, cr1=CurveRender, cr2=CurveRender):
        super(CreateNetFusion_re, self).__init__()
    ...
    def forward(self, ori_img, x, fore, label, withLabel):
        ...
        fusion_img, param1, param2, param3 = self.fusion(ori_img, x, f_feature, b_feature, label, withLabel)
