...
class Fusion(nn.Module):
    def __init__(self, plane=64, stack=False, p=Projection, final_relu=False, cr1=CurveRenderwithConcat,
        ...
        self.cr3 = cr2(self.plane, final_relu, p=p)
        self.cr4 = cr2(self.plane, final_relu, p=p)
    ...
    def forward(self, ori_img, x, f_feature, b_feature, label, withLabel):
        ...
        if self.stack:
            ...
            img_3, param3 = self.cr3(img_2, f_feature, b_feature, label)
            img_4, param4 = self.cr3(img_3, f_feature, b_feature, label)
            fusion_img = (img_4, img_3, img_2, img_1)
        ...
        # import pdb;
        # pdb.set_trace()
        return fusion_img, param1, param2, param3, param4

class CreateNetFusion_re4(nn.Module):
    def __init__(self, model, plane=64, fusion=Fusion, final_relu=False, stack=False, cr1=CurveRender, cr2=CurveRender):
        super(CreateNetFusion_re4, self).__init__()
    ...
    def forward(self, ori_img, x, fore, label, withLabel):
        ...
        fusion_img, param1, param2, param3, param4 = self.fusion(ori_img, x, f_feature, b_feature, label, withLabel)
