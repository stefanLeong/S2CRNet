...
class Options():
    ...
    def init(self, parser):
        ...
        # Training strategy
        parser.add_argument('--mode', metavar='NACHINE', default='train')
        parser.add_argument('--withLabel', default='False', type=str)
        ...
        parser.add_argument('--L1_pixel_loss', default=1.0, type=float,
                            help='L2 pixel loss')
        parser.add_argument('--lambda_NCE', default=1.0, type=float,
                            help='patchNCE loss')
        ...
        parser.add_argument('--input-size', default=256, type=int, metavar='N',
                            help='image size')
        parser.add_argument('--hr_size', default=256, type=int, metavar='N',
                            help='train high-res size')
        ...
        parser.add_argument('--nce_layers', type=str, default='0,2,3,4,6,', help='compute NCE loss on which layers')
        parser.add_argument('--num_patches', type=int, default=256, help='number of patches per layer')
        parser.add_argument('--nce_T', type=float, default=0.07, help='temperature for NCE loss')

        parser.add_argument('--min_area', type=int, default=1000, help='number of minarea in MSE')
        return parser
